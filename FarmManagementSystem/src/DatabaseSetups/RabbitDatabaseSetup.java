...
public class RabbitDatabaseSetup {
    private  static String constraints =
            "  (id int PRIMARY KEY AUTO_INCREMENT," +
                    "  gender VARCHAR(10) NULL," +
                    "  dateofbirth DATETIME NULL)";

    private static String tableName = "rabbits";
    ...
    public static void createTable() {
        ...
        try {
            ...
            System.out.println("Rabbit table ready to be used.");
    ...
    public static void dropTable() {
        ...
        try {
            repositoryHelper.executeSql(databaseConnection, createTableSql);
            System.out.println("Rabbit table deleted.");
    ...
    public static void insertRabbit(String gender) {
    ...
    public static void insertRabbit(String gender, String date) {
